...
public class PointHistory extends SoftDeletedDomain {
    ...
    public static PointHistory useHistory(
        ...
        return new PointHistory(user, reservationId, CollectType.USE, amount, currentPoint);
    }
    ...
    public static PointHistory refundHistory(
        ...
        return new PointHistory(user, reservationId, CollectType.REFUND, amount, currentPoint);
    }
}
